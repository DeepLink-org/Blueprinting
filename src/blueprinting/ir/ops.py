...
class BlockDef(NodeDef):
    ...
    @classmethod
    def compute_activation_bytes(cls, attrs: Dict[str, Any]) -> Optional[Union[int, Expr]]:
    ...
    for name in dir(module):
        ...
        if isinstance(obj, type):
            if issubclass(obj, OpDef) and obj is not OpDef:
                register_op(obj)
            elif issubclass(obj, BlockDef) and obj is not BlockDef and obj is not NodeDef:
                register_block(obj)
