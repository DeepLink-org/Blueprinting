...
from ..passes import CompilerPass, PassContext, PassContract
...
class DistributeTransformerTrainingPass(CompilerPass[ModelIR, DistributedTaskIR]):
    ...
    def run(self, ir: ModelIR, context: PassContext) -> DistributedTaskIR:
        ...
        invocations, block_memory = compile_transformer_block(model, execution)
...
class PlanTransformerTrainingPass(CompilerPass[DistributedTaskIR, PortablePlanIR]):
