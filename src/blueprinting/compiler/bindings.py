"""Typed binding objects for progressive compiler specialization."""
...
@record_type("compiler.binding.target")
@dataclass(frozen=True)
class TargetProfile:
    name: str
    architecture: str
...
class BindingSet:
    ...
    def require(self, *axes: BindingAxis) -> None:
        ...
        if missing:
            ...
            raise MissingBindingError(f"missing required compiler bindings: {names}")
