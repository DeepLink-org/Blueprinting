...
| R-06 | P1 | Pre-graduation schema is mistaken for public stability | Five IR roots remain at `0.0.0`; target producers and consumers are not connected | Keep component identities versionless and establish a graduation checklist before the first schema increment | Zero epoch enforced; graduation policy pending |
